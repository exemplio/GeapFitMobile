package com.example.geapfit.services
...
//    fun getLastCredentials(): CredentialModel? {
//        return getFromPrefs("last_credentials") {
//            gson.fromJson(it, CredentialModel::class.java)
//        }
//    }
    ...
    fun credentialResponse(): CredentialModel? {
        return getObj("last_credentials") {
            gson.fromJson(gson.toJson(it), CredentialModel::class.java)
        }
    }
    ...
    fun saveLastCredentials(credentials: CredentialModel) {
        savePrefs("last_credentials", credentials)
    }

    fun saveDeviceModel(model: String) {
        savePrefs("device_model", model)
    }
